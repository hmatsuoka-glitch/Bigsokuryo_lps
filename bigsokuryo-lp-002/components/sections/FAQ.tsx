...
const faqs = [
  {
    q: "測量の経験がなくても応募できますか？",
    a: "もちろん大歓迎です。社員の多くが未経験スタート。文系出身・他業種からの転身者も多く活躍中です。入社後の OJT と社内勉強会 (年 3 回)、先輩のフォローで現場で使える技術を身につけられます。学歴不問・人柄重視で採用しています。",
  },
  {
    q: "選考フローを教えてください。",
    a: "書類選考 → 現場責任者との 1 次面接 → 部署責任者との最終面接 → 内定の 4 段階です。筆記試験はありません。入社時期はご事情に合わせて柔軟に相談に応じます。",
  },
  {
    q: "年収はどのように決まりますか？",
    a: "前職・経験・保有資格を踏まえて個別にオファーします。試用期間は 3 ヶ月。30 歳で入社された経験者の年収実績は 1 年目 390 万 → 5 年目 520 万円です。資格手当 (測量士なら月 1.5 万円) と職務手当が別途加算されます。",
  },
  {
    q: "残業や夜勤はありますか？",
    a: "鉄道現場では線路閉鎖の関係で夜勤 (20:00 - 翌 5:00) が発生することがあります。※短縮労働あり。深夜勤務手当 (給与 ÷ 20 日 × 1.25) と 1 日 1,000 円の夜食手当を全額支給。残業手当も全額支給です。",
  },
  {
    q: "資格取得のサポートはありますか？",
    a: "測量士・測量士補は試験費用を会社が全額負担。年 3 回の社内勉強会で技術向上の機会も用意しています。資格手当は測量士 月 1.5 万、1 級土木施工管理技士 月 1 万、測量士補 月 5 千円 ほか。",
  },
  {
    q: "勤務地・通勤はどうなりますか？",
  ...
  {
    q: "面接前にカジュアル面談はできますか？",
    a: "可能です。エントリーフォームに「カジュアル面談希望」と記載いただくか、公式 LINE よりお気軽にご連絡ください。",
  },
];
